...
import { ArrowLeft, BarChart3, Check, ChevronRight, Circle, Clock3, LayoutDashboard, Music2, Pause, Play, Plus, RotateCcw, Settings2, SkipForward, Trash2, Volume2, VolumeX, X } from 'lucide-react'
...
export const ScholeView: React.FC = () => {
  ...
  return <div className="space-y-7 pb-12 font-sans animate-fadeIn">
    ...
    </section><section className="rounded-2xl border border-text-primary/10 bg-bg-surface/55 p-4 sm:p-5" aria-label="Playlist do Pomodoro">
