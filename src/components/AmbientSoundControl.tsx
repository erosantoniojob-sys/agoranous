...
export const AmbientSoundControl: React.FC = () => {
  ...
  return <aside className="ambient-surface fixed bottom-24 right-3 z-50 w-[min(88vw,13rem)] rounded-[1.3rem] p-3 sm:bottom-5 sm:right-5" aria-label="Ambiente sonoro">
